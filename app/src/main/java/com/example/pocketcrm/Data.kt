...
val andreMessages = listOf(
    Message("Mensagem de Campanha: Não perca nos...", "10:00 AM", false)
)
...
val users = listOf(
    ...
    User("andre", "André", R.drawable.andre, "Empresa 1 SA", "andre@empresa1.com.br", "11 98765-4321", "Follow up", "", "", isVip = false),
    User("julia", "Júlia", R.drawable.julia, "Empresa 3 SA", "julia@empresa3.com.br", "11 12345-6789", "Novo", "", "", isVip = false),
...
val myProfile = users.find { it.id == "jose" }!!
